...
@ContextConfiguration(initializers = TestContainersDatabaseConfigurationWithScript.class)
public class TestContainersDatabaseConfigurationWithScript implements ApplicationContextInitializer<ConfigurableApplicationContext> {
