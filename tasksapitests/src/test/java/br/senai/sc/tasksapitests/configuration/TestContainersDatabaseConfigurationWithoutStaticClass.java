...
/* Opção sem a classe estática para configuração do container */
@ContextConfiguration(initializers = TestContainersDatabaseConfigurationWithoutStaticClass.class)
public class TestContainersDatabaseConfigurationWithoutStaticClass implements ApplicationContextInitializer<ConfigurableApplicationContext> {

    private static final Logger LOGGER = LoggerFactory.getLogger(TestContainersDatabaseConfigurationWithoutStaticClass.class);
